...
# x = int(input("Lutfen pixel kordinatini giriniz x : "))
# y = int(input("Lutfen pixel kordinatini giriniz y : "))

# images = cv2.imread("c:\\Users\\User\\Desktop\\solver\\maze.jpg",cv2.IMREAD_COLOR)
# images = cv2.imread("c:\\Users\\User\\Desktop\\solver\\maze.jpg",cv2.IMREAD_GRAYSCALE)

# n_white_pix = np.argwhere(images == 255)
# print('Beyaz pixeller:', n_white_pix)
